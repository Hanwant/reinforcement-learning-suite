...
class Agent:
    def __init__(self, behaviour_model, target_model, modelpath, buffer_size=100000, min_buffer_size=10000,
        ...
        if use_hdf5:
            assert example_obs is not None, "provide example observation to instantiate hdf5 dataset"
            self.replay_buffer = ReplayBuffer_HDF5(example_obs, buffer_size, savepath=buffer_savepath,
